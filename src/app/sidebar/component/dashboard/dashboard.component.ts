...
@Component({
  ...
  imports: [AreaChartComponent,ColumnChartComponent,DateTimeAreaChartComponent, NgApexchartsModule, MatIconModule, MatInputModule, MatButtonModule, RouterOutlet, CommonModule, CanvasJSAngularChartsModule, SidebarComponent, FollowedComponent, NavbarComponent, MatDialogModule,]
})
